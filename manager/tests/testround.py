...
class RoundTestCase(TestCase):
    ...
    def test_equity_may_have_20_characters(self):
        self.round.equity = 11111111111111111
        self._assert_thing_is_valid(message="equity may have 17 characters")

    def test_equity_must_not_have_more_than_20_characters(self):
        self.round.equity = 111111111111111111
        self._assert_thing_is_invalid(message=" equity must not have more than 17 digits before decimal points")

    def test_wayra_equity_may_have_20_characters(self):
        self.round.wayra_equity = 11111111111111111
        self._assert_thing_is_valid(message="wayra_equity may have 17 digits before decimal points")

    def test_wayra_equity_must_not_have_more_than_20_characters(self):
        self.round.wayra_equity = 111111111111111111
        self._assert_thing_is_invalid(message="wayra_equity must not have more than 17 digits before decimal points")

    def test_pre_money_valuation_may_have_20_characters(self):
        self.round.pre_money_valuation = 11111111111111111
        self._assert_thing_is_valid(message="pre_money_valuation may have 17 digits before decimal points")

    def test_pre_money_valuation_must_not_have_more_than_20_characters(self):
        self.round.pre_money_valuation = 111111111111111111
        self._assert_thing_is_invalid(message="pre_money_valuation must not have more than 17 digits before decimal points")
